    ...
    <footer className="border-t bg-muted/30 mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <img src={logoImage} alt="IndianLeto" className="h-20 w-auto object-contain" />
            </div>
          ...
          <div className="space-y-4">
            ...
            <a href="mailto:connect@indianleto.com" className="text-sm text-muted-foreground hover:text-foreground transition-colors block" data-testid="link-email">
      ...
      <div className="border-t">
        <Container className="py-4">
          <p className="text-xs text-muted-foreground text-center">&copy;{t("footer.copyright")}</p>
        </Container>
      </div>
    </footer>
  );
